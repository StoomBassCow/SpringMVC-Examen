                    ...
                    <form method="POST" >
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div>
                                    <input  onkeyup="this.value = this.value.toUpperCase();" name="curp" type="text" class="form-control" id="curp" placeholder="Masrcara de curp">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="nacimiento" class="form-label">Fecha de nacimiento</label>
                                <div>
                                    <input  name="nacimiento"  type="date" class="form-control" id="nacimiento" onchange="calcular_edad()">
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="edad" class="form-label">Edad</label>
                                <div>
                                    <input  name="edad" type="text" class="form-control" id="edad"  disabled>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div>
                                    <input  name="telefono" type="text" class="form-control" id="telefono" placeholder="(000)000-00-00">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-around">

                            <input type="submit" onclick="return validar();" class="btn btn-success btn-lg" value="Agregar">
